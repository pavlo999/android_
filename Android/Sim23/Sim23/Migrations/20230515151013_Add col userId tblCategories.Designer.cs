...
namespace Sim23.Migrations
{
    ...
    [Migration("20230515151013_Add col userId tblCategories")]
    partial class AddcoluserIdtblCategories
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sim23.Data.Entitys.Identity.RoleEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Sim23.Data.Entitys.Identity.RoleEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Sim23.Data.Entitys.Identity.UserEntity", null)
                        .WithMany()
